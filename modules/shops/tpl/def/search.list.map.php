    ...
    <? if( ! $is_ajax ) { ?>
            ...
            <div class="sr-page__map_ymap span7 j-map">
                <div class="sr-page__map__controls">
                    <span id="j-search-map-toggler"><span class="j-search-map-toggler-arrow">&laquo;</span> <a href="#" class="ajax j-search-map-toggler-link"><?= _t('search', 'Մեծացնել քարտեզը'); ?></a></span>
                </div>
