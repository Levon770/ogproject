            ...
            <div class="v-descr_contact__form_file pull-left attach-file j-attach-block">
                <div class="upload-btn j-upload">
                    <span class="upload-mask">
                        <input type="file" title="<?= _t('internalmail', 'Прикрепить файл (до [maxSize])', array('maxSize'=>tpl::filesize($this->attach()->getMaxSize()) )) ?>" name="attach" class="j-upload-file" />
                    </span>
                    <a href="#" onclick="return false;" class="ajax"><i class="fa fa-paperclip" aria-hidden="true"></i></a>
                </div>
