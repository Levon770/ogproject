    ...
    <div class="row-fluid add-item">
        <div class="l-page span12">
            <div class="v-page__content">
                ...
                ?>
                <div class="l-table" style="padding: 0px 32px;width: auto;">
                    <div class="l-table-row">
                        <div class="l-main l-table-cell">
                            <div class="i-formpage">
                                            ...
                                            <div class="alert-inline">
                                                <div class="alert-inline__content">
                                                    <div class="alert alert-error rel">
                                                        <?= _t('bbs', 'Объявление было заблокировано модератором.') ?>
                                                        <br/>
                                                        <?= _t('bbs', 'Причина блокировки:') ?>
                                                ...
                                                <div class="alert-inline">
                                                    <div class="alert-inline__content">
                                                        <div class="alert alert-info rel">
                                                            ...
                                                            <a href="#" class="btn btn-info alert-action"
                                                               id="j-i-form-action-refresh"><i
                                                                        class="fa fa-refresh white"></i> <?= _t('bbs', 'Продлить') ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="alert-inline">
                                                <div class="alert-inline__content">
                                                    <div class="alert alert-info rel">
                                                        ...
                                                        <a href="#" class="btn btn-info alert-action"
                                                           id="j-i-form-action-publicate"><i
                                                                    class="fa fa-check white"></i> <?= _t('bbs', 'Опубликовать снова') ?>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <? endif; # $edit ?>
                                <form class="form-horizontal mrgt20" action="" id="j-i-form" method="POST"
                                      enctype="multipart/form-data">
                                    <? if ($publisher == BBS::PUBLISHER_USER_OR_SHOP && $shop): ?>
                                        <div class="control-group">
                                            <label class="control-label"><?= _t('item-form', 'Разместить как') ?><span
                                                        class="required-mark">*</span></label>
                                            <div class="controls">
                                                <input type="hidden" name="shop" value="<?= ($shop_id ? 1 : 0) ?>"
                                                       class="j-publisher-type"/>
                                                <div class="btn-group">
                                                    <?
                                                    foreach (array(
                                                        ...
                                                        ?>
                                                        <button type="button" class="btn<? if ($v['a']) { ?> active<? }
                                                    if ($v['d']) { ?> disabled<? } ?> j-publisher-toggle"
                                                                data-type="<?= $v['id'] ?>"><?= $v['t'] ?></button><?
                                                    endforeach;
                                                    ?>
                                                </div>
                                                <? if (!$shop_data): ?>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label"><?= _t('item-form', 'Заголовок') ?><span
                                                    class="required-mark">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="title" value="<?= $title ?>"
                                                   class="input-block-level j-required" id="j-i-title"
                                                   autocomplete="off"/>
                                    ...
                                    <div class="control-group control-group__100">
                                        <label class="control-label"><?= _t('item-form', 'Категория') ?><span
                                                    class="required-mark">*</span></label>
                                        <div class="controls">
                                            <input type="hidden" name="cat_id" class="j-cat-value j-required"
                                                   value="<?= $cat_id ?>"/>
                                            <div class="i-formpage__catselect rel">
                                                <div class="i-formpage__catselect__done j-cat-select-link-selected<? if (!$cat_id) { ?> hide<? } ?>">
                                                    <img class="abs j-icon" alt=""
                                                         src="<?= ($cat_id ? $cat_data['icon'] : '') ?>"/>
                                                    <div class="i-formpage__catselect__done_cat">
                                                        <a href="#"
                                                           class="j-cat-select-link j-title"><?= join(' &raquo; ', $cat_path) ?></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="i-formpage__catselect__close j-cat-select-link-empty<? if ($cat_id) { ?> hide<? } ?>">
                                                    <a href="#"
                                                       class="ajax ajax-ico j-cat-select-link"><span><?= _t('item-form', 'Выберите категорию') ?></span>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label"><?= _t('item-form', 'Описание') ?><span
                                                    class="required-mark">*</span></label>
                                        <div class="controls">
                                            <textarea name="descr" class="input-block-level j-required" id="j-i-descr"
                                                      rows="6" autocapitalize="off"><?= $descr ?></textarea>
                                    ...
                                    <div class="control-group j-video">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="video" value="<?= $video ?>"
                                                   class="input-block-level j-video" maxlength="1500"/>
                                            <span class="help-block"><?= _t('item-form', 'Youtube, Rutube, Vimeo') ?></span>
                                        </div>
                                    </div>
                                    <div class="control-group j-images">
                                        <input type="hidden" name="images_type" value="ajax"
                                               class="j-images-type-value"/>
                                        <input type="hidden" name="images_hash" value="<?= $imghash ?>"/>
                                        <label class="control-label"><?= _t('item-form', 'Фотографии') ?><br/>
                                            <small><?= _t('item-form', 'Объявления с фото получают в среднем в 3-5 раз больше откликов') ?></small>
                                        </label>
                                        <div class="controls">
                                            <div class="alert alert-info"
                                                 style="font-size: 12px;text-align: center;padding: 8px;">
                                                <i class="fa fa-lightbulb-o"
                                                   style="font-size: 22px; vertical-align: sub; color: #3a87ad;"></i>
                                                Խնդրում ենք համոզվեք, որ ձեր նկարները չեն պարունակում որևէ կոնտակտային
                                                ինֆորմացիա։
                                            </div>
                                            <div class="i-form__addphotos j-images-type j-images-type-ajax">
                                                <ul class="unstyled j-img-slots">
                                                    <? for ($i = 1; $i <= BBS::CATS_PHOTOS_MAX; $i++): ?>
                                                        <li class="i-form__addphotos__item<? if ($i > $imagesLimit) { ?> hide<? }
                                                        if ($i == 1) { ?> i-form__addphotos__item_first<? } ?> j-img-slot">
                                                            <span class="j-img-upload">
                                                                <a class="i-form__addphotos__item__plus j-img-link"
                                                                   href="javascript:void(0);" title="<?= $lang_image_add ?>">+</a>
                                                            </span>
                                                                                <span class="j-img-preview hide">
                                                                <a class="i-form__addphotos__item__del j-img-link" href="#"
                                                                   title="<?= $lang_image_del ?>"><i class="fa fa-times white"></i></a>
                                            ...
                                            <div class="i-form__addphotos_simple hide j-images-type j-images-type-simple">
                                                <? for ($i = 1; $i <= BBS::CATS_PHOTOS_MAX; $i++): ?>
                                                    <input type="file" name="images_simple_<?= $i ?>"
                                                           class="<? if ($i > $imagesLimit) { ?>hide <? } ?>j-img-slot"/>
                                                <? endfor; ?>
                                            </div>
                                            <span>
                                ...
                                <small class="j-togglers hide"><a href="#" class="ajax j-toggler"
                                                                  data-type="ajax"><?= _t('item-form', 'Удобная форма загрузки фотографий') ?></a></small>
                            </span>
                                        </div>
                                    </div>
                                    <div class="i-formpage__subtitle"><b><?= _t('item-form', 'Местоположение') ?></b>
                                    </div>
                                    <div class="l-spacer"></div>
                                    <div class="j-geo">
                                        <div class="control-group">
                                            <label class="control-label"><?= _t('item-form', 'Город') ?><span
                                                        class="required-mark">*</span></label>
                                            <div class="controls">
                                        ...
                                        <? if (Geo::districtsEnabled()): $bDistricts = false;
                                            if ($city_id) {
                                                $bDistricts = count(Geo::districtList($city_id)) > 0;
                                            } ?>
                                            <div class="control-group j-geo-district<?= !$bDistricts ? ' hide' : '' ?>">
                                                <label class="control-label"><?= _t('item-form', 'Район') ?></label>
                                                <div class="controls">
                                                    <select name="district_id"
                                                            autocomplete="off"><?= Geo::districtOptions($city_id, $district_id, _t('item-form', 'Не указан')) ?></select>
                                                </div>
                                            </div>
                                        <? endif; ?>
                                        <div class="control-group j-geo-metro<? if (!$city_id || !$city_data['metro']) { ?> hide<? } ?>">
                                            <input type="hidden" name="metro_id" value="<?= $metro_id ?>"
                                                   class="j-geo-metro-value"/>
                                            ...
                                            <div class="controls rel">
                                                <div class="i-formpage__metroselect">
                                                    <div class="i-formpage__metroselect__close j-geo-metro-link-empty<? if ($metro_id) { ?> hide<? } ?>">
                                                        <a href="#"
                                                           class="ajax ajax-ico j-geo-metro-link"><span><?= _t('item-form', 'Выберите станцию') ?></span>
                                                            <i class="fa fa-chevron-down"></i></a>
                                                    </div>
                                                    <div class="i-formpage__metroselect__done j-geo-metro-link-selected<? if (!$metro_id) { ?> hide<? } ?>">
                                                        <div class="i-formpage__metroselect__done_cat">
                                                            <span class="i-formpage__metroselect__item inlblk j-color"
                                        ...
                                        <div id="j-i-geo-addr"<? if (!$cat_id || !$cat_data['addr']) { ?> class="hide"<? } ?>>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="hidden" name="addr_lat" id="j-i-geo-addr-lat"
                                                           value="<?= $addr_lat ?>"/>
                                                    <input type="hidden" name="addr_lon" id="j-i-geo-addr-lon"
                                                           value="<?= $addr_lon ?>"/>
                                                    <input type="text" name="addr_addr" class="input-block-level"
                                                           id="j-i-geo-addr-addr" value="<?= $addr_addr ?>"/>
                                                    <span class="help-block"><?= _t('item-form', 'Укажите улицу, район, номер дома и т.п.') ?></span>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div id="j-i-geo-addr-map"
                                                         style="height: 250px; width: 100%; max-width: 470px;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="i-formpage__subtitle j-i-contacts-block">
                                        <b><?= _t('item-form', 'Ваши контактные данные') ?></b></div>
                                    <div class="l-spacer"></div>
                                    ...
                                    <? } ?>
                                    <div class="control-group<? if (($shop && $publisher_only_shop) || ($contactsFromProfile && $edit)) { ?> hide<? } ?>"
                                         id="j-i-name-block">
                                        <label class="control-label"><?= _t('item-form', 'Контактное лицо') ?><span
                                                    class="required-mark">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="name"
                                                   class="input-xlarge<? if (!$contactsFromProfile) { ?> j-required<? } ?>"
                                                   value="<?= $name ?>"<? if ($contactsFromProfile) { ?> readonly="readonly"<? } ?>
                                                   placeholder="" id="j-i-name" maxlength="50"/>
                                    ...
                                    <? if (Users::registerPhone()) { ?>
                                        <div class="control-group">
                                            <label class="control-label"><?= _t('item-form', 'Номер телефона') ?><span
                                                        class="required-mark">*</span></label>
                                            <div class="controls">
                                                ...
                                                <? } else { ?>
                                                    <input type="text" class="input-xlarge"
                                                           value="+<?= HTML::escape($phone_number) ?>"
                                                           disabled="disabled"/>
                                    ...
                                    <div class="control-group<? if ($edit) { ?> hide<? } ?>">
                                        <label class="control-label"><?= _t('item-form', 'E-mail адрес') ?><span
                                                    class="required-mark">*</span></label>
                                        <div class="controls">
                                            <input type="email" name="email"
                                                   value="<?= (!empty($email) ? HTML::escape($email) : '') ?>" <? if ($nUserID) { ?> readonly="readonly"<? } ?>
                                                   class="input-xlarge j-required" maxlength="100" autocorrect="off"
                                                   autocapitalize="off"/>
                                    ...
                                    <? if (!$edit && bff::servicesEnabled() && !Users::registerPhone()) { ?>
                                        <div class="j-svc-block" style="display:none;">
                                            <div class="i-formpage__subtitle">
                                                <b><?= _t('item-form', 'Продвижение объявления') ?></b></div>
                                            <div class="l-spacer"></div>
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="i-formpage__promotion">
                                                            ...
                                                            <div class="i-formpage__promotion__item j-svc-item j-svc-<?= $v['id'] ?>">
                                                                <label>
                                                                    <div class="i-formpage__promotion__item__title"
                                                                        ...
                                                                        <label class="radio">
                                                                            <input type="radio" name="svc"
                                                                                   value="<?= $v['id'] ?>"/>
                                                                            <div class="control__indicator"></div>
                                                                            <div class="i-formpage__promotion__item__icon">
                                                                                <img src="<?= $v['icon_s'] ?>" alt=""/>
                                                                            </div><?= $v['title_view'] ?> <span
                                                                                    class="pull-right"><b
                                                                                        class="j-price"><?= $v['price'] ?></b> <?= $curr ?></span>
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="i-formpage__promotion__item active last i-promotion_free j-svc-item j-svc-0">
                                                            <label>
                                                                <div class="i-formpage__promotion__item__title">
                                                                    <label class="radio">
                                                                        <input type="radio" name="svc" value="0"
                                                                               checked="checked"/>
                                                                        <div class="control__indicator"></div>
                                                                        <div class="i-formpage__promotion__item__icon">
                                                                            <img src="<?= SITEURL_STATIC . '/img/square-grey.png' ?>"
                                                                                 alt=""/>
                                                                        </div><?= _t('item-form', 'Бесплатное объявление') ?>
                                                                        <span class="pull-right"><?= _t('item-form', '') ?></span>
                                                                    </label>
                                                                </div>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="checkbox inline">
                                                    <input name="agree" type="checkbox" class="j-required"/>
                                                    <small><?= _t('item-form', 'Ես համաձայն եմ ogut.am կայքի <a [link_agreement]>օգտագործման կանոնների հետ</a> և ծանոթացել եմ ogut.am կայքի Օգտագործման համաձայնագիրին։', array('link_agreement' => 'href="' . Users::url('agreement') . '" target="_blank"', 'site_title' => config::sys('site.title'))) ?>
                                                        <span class="required-mark">*</span></small>
                                                </label>
                                            </div>
                                        </div>
                                    <? endif; ?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="submit" class="btn btn-success j-submit"
                                                   ...
                                                   data-loading-text="<?= _t('item-form', 'Подождите...') ?>"/>
                                            <? if ($edit) { ?><span class="i-formpage__cancel_mobile btn-link j-cancel">
                                                &nbsp;&nbsp; <?= _t('', 'Отмена') ?></span> <? } ?>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="l-right l-table-cell visible-desktop">
                            <div class="l-right__content">
                                ...
                                <div class="formrule visible-desktop">
                                    <div class="content">
                                        <div class="desc">
                                            <p>Ավելացրեք Ձեր հատարարությունն անվճար</p>
                                            <p class="p_info_form"><i class="fa fa-hand-paper-o" aria-hidden="true"></i>
                                                Ուշադրություն</p>
                                            <div class="info">Որպեսզի ձեր հայտարարությունը հրապարակվի խնդում ենք հետևել
                                                կանոներին․:
                                            </div>
                                            <ul>
                                                <li>Հայտարարության վերնագրում և լուսանկարներում մի նշեք հեռախոսահամար,
                                                    էլ․ հասցե կամ կայքի հասցե:
                                                </li>
                                                <li>Մի առաջարկեք <a target="_blank" href="/forbidden.html"
                                                                    title="արգելված ապրանքներ կամ ծառայություններ">արգելված
                                                        ապրանքներ կամ ծառայություններ:</a></li>
                                            </ul>
                                            <hr>
                                            <ul>
                                                <li>Նույն հայտարարությունը չի կարելի հրապարակել մի քանի անգամ։<a
                                                            target="_blank"
                                                            href="/forbidden.html"
                                                            title="Նույն հայտարարությունը չի կարելի հրապարակել մի քանի անգամ Ինչու՞">Ինչու՞</a>
                                                </li>
                                                <div class="att-congrats">Մաղթում ենք ձեզ հաջող վաճառք: </div>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<? else: ?>
    <div class="alert alert-warning "><?= _t('BBS', 'Հայտարարություն ավելացնելու համար խնդրում ենք <a href="/user/register">գրանցվել</a> կամ <a href="/user/login">մուտք գործել</a>'); ?></div>
<? endif; ?>
<script type="text/javascript">
    ...
    $(function () {
        ...
        $jsSettings = array(
            ...
            # lang
            'lang' => array(
                'maxlength_symbols_left' => _t('', '[symbols] հնարավորություն'),
                'maxlength_symbols' => _t('', 'նիշի;նիշի;նիշի'),
                'upload_typeError' => _t('item-form', 'Допустимы только следующие типы файлов: {extensions}'),
                'upload_sizeError' => _t('item-form', '"{file} ֆայլը չափազանց մեծ է, թույլատրելի մաքսիմալ չափսն է {sizeLimit}'),
                'upload_minSizeError' => _t('item-form', '{file} ֆայլի չափսը սխալ է'),
                'upload_emptyError' => _t('item-form', '{file} ֆայլի չափսը սխալ է'),
                'upload_limitError' => _t('item-form', 'Չի թույլատրվում ներբեռնել {limit}-ից ավել ֆայլ'),
                'upload_onLeave' => _t('item-form', 'Նկարը ներբեռնվում է, խնդրում ենք սպասել'),
                'email_wrong' => _t('users', 'Էլ․ հասցեն նշված է սխալ'),
                'phones_tip' => _t('item-form', 'Հեռախոսահամար'),
                'phones_plus' => _t('item-form', '+ ещё<span [attr]> телефон</span>', array('attr' => 'class="hidden-phone"')),
                'phones_req' => _t('item-form', 'Նշեք հեռախոսահամրը'),
                'price' => _t('item-form', 'Նշեք գինը'),
            ),
        );
