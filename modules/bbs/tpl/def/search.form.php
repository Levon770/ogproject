            ...
            <form id="j-f-form" action="<?= BBS::url('items.search', $catData) ?>" method="get" class="form-inline rel">
                ...
                <? if( DEVICE_DESKTOP_OR_TABLET ) { ?>
                    ...
                    <div class="f-msearch_desktop hidden-phone">
                        <table width="100%">
                            <tr>
                                ...
                                <td class="region" width="10">
                                    <a href="#" class="f-msearch_desktop__category btn btn-default nowrap" id="j-f-region-desktop-link">
                            <span id="j-f-region-desktop-link" class="title">
                                <i class="fa fa-location-arrow" style="color: #999999;font-size: 16px;"></i> <?= ( $regionID > 0 ? $regionData['title'] : $titleAll ) ?></span> <i class="fa fa-caret-down"></i></a>
                                </td>
                                <td width="70">
                        ...
                        <div id="j-f-cat-desktop-popup" class="f-msearch__categories f-msearch__subcategories dropdown-block box-shadow abs hide">
                        ...
                        <? if( ! bff::isIndex() ) { ?>
                            ...
                            <div class="select-ext select-ext-group">
                                <div class="select-ext-container " style="width:100%">
                                    ...
                                    <div id="j-f-cat-phone-popup" class="select-ext-drop hide"  style="width: calc(100% - 2px);">
