    ...
    <div class="l-table-row">
        <div class="l-table-cell u-authorize-form">
            <form id="j-u-login-form" action="" class="form-horizontal">
                ...
                <div class="control-group">
                    <div class="controls">
                        <button type="submit" class="btn j-submit"><?= _t('users', 'Մուտք') ?></button>
                        <a class="pull-right forget-pass" href="<?= Users::url('forgot') ?>"><?= _t('users', 'Մոռացել ե՞ք գաղտնաբառը') ?></a>
                    </div>
...
<div class="u-sc visible-phone">
    ...
    <span><?= _t('users', 'Մուտք սոց․ ցանցերի միջոցով') ?></span>
    <? foreach($providers as $v) {
