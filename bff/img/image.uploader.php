   ...
   public function delete($bUpdateRecord = true, $sFilename = false)
    ...
    protected function checkDimensions($Da3cfeab33a3de97, $na159cfba58ad1874a)
    {
        if( 0 < $this->minWidth && $Da3cfeab33a3de97 < $this->minWidth ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("img", "Խնդրում ենք ներբեռնել [width]px-ից լայն նկար", array( "width" => $this->minWidth )));
            }
        ...
        if( 0 < $this->maxWidth && $this->maxWidth < $Da3cfeab33a3de97 ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("img", "Խնդրում ենք ներբեռնել [width]px-ից ոչ լայն նկար", array( "width" => $this->maxWidth )));
            }
        ...
        if( 0 < $this->minHeight && $na159cfba58ad1874a < $this->minHeight ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("img", "Խնդրում ենք ներբեռնել [height]px-ից երկար նկար", array( "height" => $this->minHeight )));
            }
        ...
        if( 0 < $this->maxHeight && $this->maxHeight < $na159cfba58ad1874a ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("img", "Խնդրում ենք ներբեռնել [height]px-ից ոչ երկար նկար", array( "height" => $this->maxHeight )));
            }
