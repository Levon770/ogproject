...
class CImagesUploader extends Component
{
    ...
    protected function checkDimensions($C2f3b5f70d1547e76, $y254e73826)
    {
        if( 0 < $this->minWidth && $C2f3b5f70d1547e76 < $this->minWidth ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("uploader", "Խնդրում ենք ներբեռնել [width]px-ից մեծ նկար", array( "width" => $this->minWidth )));
            }
        ...
        if( 0 < $this->maxWidth && $this->maxWidth < $C2f3b5f70d1547e76 ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("uploader", "Խնդրում ենք ներբեռնել [width]px-ից փոքր նկար", array( "width" => $this->maxWidth )));
            }
        ...
        if( 0 < $this->minHeight && $y254e73826 < $this->minHeight ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("uploader", "Ներբեռնվող նկարի բարձրությունը թույլատրվող [height]px-ից քիչ է", array( "height" => $this->minHeight )));
            }
        ...
        if( 0 < $this->maxHeight && $this->maxHeight < $y254e73826 ) 
        {
            if( $this->assignErrors ) 
            {
                $this->errors->set(_t("uploader", "Ներբեռնվող նկարի բարձրությունը թույլատրվող [height]px-ից շատ է", array( "height" => $this->maxHeight )));
            }
