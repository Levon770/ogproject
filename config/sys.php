...
$config = array(
    ...
    'site.host'   => 'ogut.am',
    'site.static' => '//ogut.am',
    'site.title'  => 'Ogut.am', // название сайта, для подобных случаев: "Я уже зарегистрирован на {Example.com}"
    /**
    ...
    'db.name' => 'ogut_bazasvetik',
    'db.user' => 'ogut_svetik',
    'db.pass' => 'hEBalw4RLh9IJZgix5WyWOABy6kQHFoxKV314Diq',
    'db.charset' => 'UTF8',
    'db.prefix' => 'bff_',
    /**
     * Mail
